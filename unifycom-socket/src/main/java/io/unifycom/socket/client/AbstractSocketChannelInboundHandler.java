...
public abstract class AbstractSocketChannelInboundHandler extends SimpleChannelInboundHandler<Object> {
    ...
    public AbstractSocketChannelInboundHandler(ChannelDispatcher channelEventDispatcher) {

        this(channelEventDispatcher, null, null);
    }

    public AbstractSocketChannelInboundHandler(ChannelDispatcher channelDispatcher, Channel channel, Ping ping) {
